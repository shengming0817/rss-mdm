...
Apple 迁移增加 `apple-management-v1` 单元（原 Apple 版本 ledger 39 → 40），旧 SQL 保持不变。与企业任务合并后的当前账本为 46 单元，接受精确的 39 或 40 单元基线；升级还须满足 [Agent V2 与企业任务前置检查](202609230002-2468-enterprise-task-upgrade.md)。更早、未知、未完成或摘要不匹配账本拒绝。
