...
本目录承载私有化安装、配置、证书及 Apple 外部依赖、数据库迁移、升级回退、备份恢复与运行诊断。已有 Docker 候选 候选构建入口；发布资格以具体候选的受测证据和独立 T3 为准。
...
- [命令服务前向升级](202609210000-2465-command-upgrade.md)：追加迁移、最小角色与新配置切换。
