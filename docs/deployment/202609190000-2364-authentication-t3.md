...
```sh
make t3-auth MDM_CANDIDATE=/absolute/candidate MDM_WEB_IMAGE=rss-identity-web:2364-logout-final MDM_BROWSER_IMAGE=rss-identity-reference-tools:1062-final MDM_T3_OUTPUT=/absolute/new-result
```
